...
var accessSurfacesInternal = []AccessSurface{
	...
	routeSurfaceInternal("route.customize.registries.browse", "/customize/registries/{id}", "Registry repositories", AccessScopeModeGlobalOnly, []string{PermRegistriesBrowse}, 0),
	routeSurfaceInternal("route.customize.registries.repository", "/customize/registries/{id}/repository", "Registry repository", AccessScopeModeGlobalOnly, []string{PermRegistriesBrowse}, 0),
